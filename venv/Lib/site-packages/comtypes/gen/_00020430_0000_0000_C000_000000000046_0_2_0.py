...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_PIXELS', 'Unchecked', 'OLE_XPOS_PIXELS',
           'Monochrome', 'OLE_HANDLE', 'OLE_OPTEXCLUSIVE',
           'IPictureDisp', 'OLE_YPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'Gray', 'FONTSTRIKETHROUGH', 'OLE_XSIZE_CONTAINER',
           'IFontEventsDisp', 'Default', 'OLE_ENABLEDEFAULTBOOL',
           'IFontDisp', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_CONTAINER',
           'OLE_XPOS_CONTAINER', 'Color', 'OLE_COLOR', 'FONTSIZE',
           'OLE_CANCELBOOL', 'IFont', 'Picture', 'StdFont',
           'FontEvents', 'Checked', 'FONTUNDERSCORE', 'OLE_TRISTATE',
           'VgaColor', 'FONTITALIC', 'IPicture', 'Font',
           'OLE_XSIZE_PIXELS', 'FONTBOLD', 'LoadPictureConstants',
           'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC', 'StdPicture']
from comtypes import _check_version; _check_version('', 1607423540.888138)
